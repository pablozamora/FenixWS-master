...
//  delay(4000);
 ...
 // Almacenamiento de datos documento excel (1 archivo por mes)
  ...
  if ( mes == "1"){
    ...
    if (((minuto== "10") || (minuto== "20") || (minuto== "30") || (minuto== "40") || (minuto== "50") || (minuto== "01")) & ((segundo == "10") || (segundo == "11"))){
 ...
 //DATOS DEL MES DE MARZO
  ...
  if ( mes == "7"){
    //Alamcenamiento de archivos cada 10 minutos 
    if (((minuto== "10") || (minuto== "20") || (minuto== "30") || (minuto== "40") || (minuto== "50") || (minuto== "01")) & ((segundo == "10") || (segundo == "11"))){
      File dataFile = FileSystem.open("/mnt/sda1/arduino/www/estacionCATIE_JULIO_prueba.xls", FILE_APPEND);
      if (dataFile){
        dataFile.println(dataString);
        dataFile.close();
        Console.println(dataString);
        Console.println("Dato actualizado");
      }
      else{
        Console.println("FAIL");
      }
 ...
 //Envío de email automático para alertar de creación de archivo al finalizar el mes
    if ((dia=="1") & (hora=="9") & (minuto=="10") & ((segundo=="10") || (segundo=="11"))){
      Process p;
      p.runShellCommand("cat alrt_data.txt | ssmtp salasa@catie.ac.cr"); // ********** CREAR ARCHIVO alrt_data.txt en /root/tmp/ 
      Console.println("DATOS del mes Almacenados Correctamente");
      Console.println(" ");
    }
   
   if ((hora=="0") & (minuto=="0") & ((segundo=="10") || (segundo=="11"))){
     RainAccum=0;
   }
   
  //Despliegue de Datos monitor Console
  Console.print(dataString);
  Console.print("Radiacion Solar (W/m2) : ");
  Console.println(RadiationSolar);
  Console.print("Velocidad del viento (m/s): ");
  Console.println(WindSpeed);
  Console.print("Acumulador: ");
  Console.println(RainAccum);
  Console.println(Windvoltage);
  Console.print("Temperatura: ");
  Console.println(temp_degc);
  Console.print("Humedad relativa: ");
